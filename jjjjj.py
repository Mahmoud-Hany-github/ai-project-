...
api_config = {
    "Alpha Vantage": {
        "endpoint": "https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol={ticker}&interval=1min&apikey={api_key}",
        "params": ["ticker"],
...
def fetch_and_save_api_data():
    targets = {"Alpha Vantage": {"ticker": "AAPL"}}
